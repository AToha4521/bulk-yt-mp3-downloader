...
3. Run the **batch file** (`yt_bulk_download.bat`) by double-clicking it or via Command Prompt.

4. If `yt-dlp` is not found, follow the instructions to install it.

5. Enter your **YouTube playlist URL** inside the `.bat` file. (use with any text editor example Notepad)
